...
```{r}
ggplot(data = mpg) +
  geom_point(mapping = aes(x = displ, y = cyl, color = cty))
#kategorinis - skirtingi elementai
#tolydusis - elementu gradientas
```
```{r}
ggplot(data = mpg) +
...
```{r}
ggplot(data = mpg) +
  geom_point(mapping = aes(x = displ, y = cyl), stroke = 2)
#keicia stori
#reikia naudotis helpu
```
...
```{r}
ggplot(data = mpg) +
  geom_point(mapping = aes(x = displ, y = cyl, color = class, size = year))
#naudoja abu
```
...
```{r}
ggplot(data = mpg) +
  geom_point(mapping = aes(x = displ, y = cyl, color = class, shape = class))
#naudoja abi skales
```
...
```{r}
ggplot(data = mpg) +
  geom_point(mapping = aes(x = displ, y = cyl, color = displ <5))
#skale padalinama i 2 logines dalis pagal atlikta veiksma
```
